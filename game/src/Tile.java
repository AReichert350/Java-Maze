 ...
 *          lines are. A tile can also communicate its current orientation and
 *          where its "correct" location ("home") is.
 *          Additionally generates the random placement of each of the 16 tiles
 *          for "original" mazes.
 */
